...
export default function SelectSinglePortfolioModal({
  open = false,
  setOpen,
  imageList,
  selectedData,
  ...
  const handleImageClick = (image) => {
    try {
      ...
      // newSelected?.push({ url: image.url, public_id: image.public_id });

      setSelectedUpdate(!selectedUpdate);
      setSelected([{ url: image.secure_url, public_id: image.public_id }]);
    } catch (error) {
      console.error(error);
    }
  };
