...
const TABLE_HEAD = [
  ...
  { id: "ref_id", label: "Ref ID", alignRight: false },
  { id: "card_name", label: "Card/Name", alignRight: false },
  { id: "Country", label: "Country", alignRight: true },
  { id: "Amount", label: "Amount", alignRight: true },
  { id: "Status", label: "Status", alignRight: true },
  { id: "create_date", label: "Create Date", alignRight: true },
  { id: "status_date", label: "Status Date", alignRight: true },
...
export default function Transactions() {
  ...
  const pageTitle = "Transactions | CashOnex Admin";
  return (
